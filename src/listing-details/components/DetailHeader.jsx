    ...
    return (
        <div>
            {carDetail?.listingTitle ? <div>
                ...
                <p className='text-sm mt-2'>{carDetail?.tagline}</p>
                <div className='flex gap-2 mt-3'>
                    ...
                    <div className='flex gap-2 items-center bg-blue-100 rounded-full p-2 px-3'>
                        ...
                        <IoMdSpeedometer className='h-5 w-5 text-primary' />
            ...
            </div> : <div className='w-full rounded-xl h-[100px] bg-slate-200 animate-pulse'></div>}
        </div>
    )
}
